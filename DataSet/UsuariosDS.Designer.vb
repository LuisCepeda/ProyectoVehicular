...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("UsuariosDS"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class UsuariosDS
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As UsuariosDS = CType(MyBase.Clone,UsuariosDS)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "UsuariosDS"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/UsuariosDS.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As UsuariosDS = New UsuariosDS()
    ...
    Partial Public Class UsuariosDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddUsuariosRow(ByVal Nombre As String, ByVal Documento As String, ByVal Password As String, ByVal ID_Rol As Integer, ByVal Activo As Boolean) As UsuariosRow
            Dim rowUsuariosRow As UsuariosRow = CType(Me.NewRow,UsuariosRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Nombre, Documento, Password, ID_Rol, Activo}
    ...
    Partial Public Class UsuariosRow
        ...
        Public Property Documento() As String
            Get
                ...
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'Documento' in table 'Usuarios' is DBNull.", e)
                End Try
            End Get
            Set
        ...
        Public Property ID_Rol() As Integer
            Get
                ...
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'ID_Rol' in table 'Usuarios' is DBNull.", e)
                End Try
            End Get
            Set
...
Namespace UsuariosDSTableAdapters
    ...
    Partial Public Class UsuariosTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Usuarios] WHERE (([Id] = @Original_Id) AND ((@IsNull_Nombre = "& _ 
                "1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_Document"& _ 
                "o = 1 AND [Documento] IS NULL) OR ([Documento] = @Original_Documento)) AND ((@Is"& _ 
                "Null_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) "& _ 
                "AND ((@IsNull_ID_Rol = 1 AND [ID_Rol] IS NULL) OR ([ID_Rol] = @Original_ID_Rol))"& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Usuarios] ([Nombre], [Documento], [Password], [ID_Rol], [Activ"& _ 
                "o]) VALUES (@Nombre, @Documento, @Password, @ID_Rol, @Activo);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, Nombr"& _ 
                "e, Documento, Password, ID_Rol, Activo FROM Usuarios WHERE (Id = SCOPE_IDENTITY("& _ 
                "))"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Usuarios] SET [Nombre] = @Nombre, [Documento] = @Documento, [Passwo"& _ 
                "rd] = @Password, [ID_Rol] = @ID_Rol, [Activo] = @Activo WHERE (([Id] = @Original"& _ 
                "_Id) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nom"& _ 
                "bre)) AND ((@IsNull_Documento = 1 AND [Documento] IS NULL) OR ([Documento] = @Or"& _ 
                "iginal_Documento)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Passw"& _ 
                "ord] = @Original_Password)) AND ((@IsNull_ID_Rol = 1 AND [ID_Rol] IS NULL) OR (["& _ 
                "ID_Rol] = @Original_ID_Rol)) AND ((@IsNull_Activo = 1 AND [Activo] IS NULL) OR ("& _ 
                "[Activo] = @Original_Activo)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Id, Nombre, Documento, Password, ID_Rol,"& _ 
                " Activo FROM Usuarios WHERE (Id = @Id)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Id, Nombre, Documento, Password, ID_Rol, Activo FROM dbo.Usuarios"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT        Id, Nombre, Documento, Password, ID_Rol, Activo"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            Us"& _ 
                "uarios"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (Documento = @documento)"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@documento", Global.System.Data.SqlDbType.VarChar, 15, Global.System.Data.ParameterDirection.Input, 0, 0, "Documento", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As UsuariosDS.UsuariosDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As UsuariosDS.UsuariosDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As UsuariosDS.UsuariosDataTable = New UsuariosDS.UsuariosDataTable()
        ...
        Public Overloads Overridable Function FillByDocumento(ByVal dataTable As UsuariosDS.UsuariosDataTable, ByVal documento As String) As Integer
        ...
        Public Overloads Overridable Function GetDataBy(ByVal documento As String) As UsuariosDS.UsuariosDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (documento Is Nothing) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = Global.System.DBNull.Value
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As UsuariosDS.UsuariosDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As UsuariosDS) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Id As Integer, ByVal Original_Nombre As String, ByVal Original_Documento As String, ByVal Original_Password As String, ByVal Original_ID_Rol As Global.System.Nullable(Of Integer), ByVal Original_Activo As Global.System.Nullable(Of Boolean)) As Integer
            ...
            If (Original_ID_Rol.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(8).Value = CType(Original_ID_Rol.Value,Integer)
            Else
        ...
        Public Overloads Overridable Function Insert(ByVal Nombre As String, ByVal Documento As String, ByVal Password As String, ByVal ID_Rol As Global.System.Nullable(Of Integer), ByVal Activo As Global.System.Nullable(Of Boolean)) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Nombre As String, ByVal Documento As String, ByVal Password As String, ByVal ID_Rol As Global.System.Nullable(Of Integer), ByVal Activo As Global.System.Nullable(Of Boolean), ByVal Original_Id As Integer, ByVal Original_Nombre As String, ByVal Original_Documento As String, ByVal Original_Password As String, ByVal Original_ID_Rol As Global.System.Nullable(Of Integer), ByVal Original_Activo As Global.System.Nullable(Of Boolean), ByVal Id As Integer) As Integer
            If (Nombre Is Nothing) Then
            ...
            If (Original_ID_Rol.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(13).Value = CType(Original_ID_Rol.Value,Integer)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Nombre As String, ByVal Documento As String, ByVal Password As String, ByVal ID_Rol As Global.System.Nullable(Of Integer), ByVal Activo As Global.System.Nullable(Of Boolean), ByVal Original_Id As Integer, ByVal Original_Nombre As String, ByVal Original_Documento As String, ByVal Original_Password As String, ByVal Original_ID_Rol As Global.System.Nullable(Of Integer), ByVal Original_Activo As Global.System.Nullable(Of Boolean)) As Integer
            Return Me.Update(Nombre, Documento, Password, ID_Rol, Activo, Original_Id, Original_Nombre, Original_Documento, Original_Password, Original_ID_Rol, Original_Activo, Original_Id)
        End Function
    End Class
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As UsuariosDS, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As UsuariosDS, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._usuariosTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As UsuariosDS, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._usuariosTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As UsuariosDS) As Integer
